...
RUN groupadd -r govinfo && useradd -r -g govinfo -m govinfo
...
RUN chown -R govinfo:govinfo /src
...
ENV PYTHONUNBUFFERED=1 \
    ...
    LOG_LEVEL=INFO \
    LOG_FORMAT=json \
    API_BASE_URL=https://www.govinfo.com/api/rest/v4/
...
LABEL org.opencontainers.image.title="GovInfo MCP Server" \
      ...
      org.opencontainers.image.source="https://github.com/yourusername/govinfo-mcp"
